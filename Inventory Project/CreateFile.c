//  PROJECT #6 File Creation Program //

/* CreateFile.c by Justin Becker

Input:   Keyboard
Output:  Screen and Becker.txt disk file

This is a program that will create a disk file and write data to it.
...
// =================================================================================================
// Clear the screen and issue warning to user that they are about to overwrite the inventory file
  system("cls"); // clears the screen 

// Alert user that they are about to overwrite inventory file and ask if they want to continue
  printf("\nYou are about to overwrite the Gear Inventory file. \nIf you continue, all previously entered data will be lost.\a\a\a"); 
...
// OPEN FILE IN WRITE MODE   
  // attempt to open file in "write" mode and assign it to the file pointer
  if ((data_file = fopen("Becker.txt","w")) == NULL)    // UPDATE TO YOUR DISK FILE NAME
  {
	printf("File location could not be opened for writing, program will exit\n");
	exit(1); // program ends here if file pointer returns NULL due to unknown abnormal condition
  }
// =================================================================================================
// PROCESSING
  // proceed if the file was opened properly for writing
// =================================================================================================
// HEADING
